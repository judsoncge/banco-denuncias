$(document).ready(function(){
	...
	$('#filtroncd, #filtrosituacao, #filtroresponsavel, #filtrounidade, #filtroassunto, #filtromunicipio, #filtroperiodoinicio, #filtroperiodofim, #filtrorestrito, #filtroanalise, #filtropalavrachave, #filtrotrilha').bind("keyup change", function(){
